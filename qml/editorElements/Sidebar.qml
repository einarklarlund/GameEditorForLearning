...
MultiResolutionImage {
  ...
  property alias savedItemOverlay: savedItemOverlay
  ...
  Item {
    ...
    Flickable {
      ...
      contentWidth: width
      contentHeight: savedItemOverlay.visible ? savedItemOverlay.height : buildColumn.height
      ...
      Column {
        ...
        ItemCreationOverlay {
          ...
          visible: entityGroups.activeGroup == 4
        }
        ...
        SavedItemOverlay {
          id: savedItemOverlay
          visible: entityGroups.activeGroup == 5
        }
        ...
        /**
         * Custom item BuiltEntityButtons --------------------------------
         */
    ...
    ItemGroupButton {
      ...
      selected: entityGroups.activeGroup == 4

      onClicked: changeActiveEntityGroup(4)
    }
    ...
    ItemGroupButton {
      ...
      selected: entityGroups.activeGroup == 5

      onClicked: {
          // set the custom items for the overlay
          customItemManager.loadItems();
//          savedItemOverlay.reloadButtons();

          // change active group to disable other elements on the sidebar
          changeActiveEntityGroup(5);
      }
    }
  }
...
//  function reloadSavedItemButton(buttonIndex) {
//      savedItemOverlay.reloadButton(buttonIndex);
//  }
  ...
  function unselectAllButtons() {
    ...
    for(i=0; i<savedItemOverlay.savedItemButtons.length; i++) {
      savedItemOverlay.savedItemButtons[i].isSelected = false
    }
  ...
  function unselectAllButtonsButOne(button) {
    ...
    if(button) {
      if(typeof button.isSelected == "undefined") {
          console.log("button.isSelected is undefined for " + button.id);
      }
