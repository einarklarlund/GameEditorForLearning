...
Opponent {
  ...
  // set image
  image.source: isCustomized && customConfiguration != undefined  && customConfiguration != null ?
                      customConfiguration.imageSource :
                      "../../assets/opponent/opponent_jumper.png"
  ...
  PolygonCollider {
    ...
    vertices:  isCustomized ? [
        Qt.point(0, 0),
        Qt.point(0,height - 1),
        Qt.point(width - 1, 0),
        Qt.point(width - 1, height - 1)
      ] : [
        Qt.point(1, 1),
        Qt.point(31, 1),
        Qt.point(31, 30),
  ...
  Timer {
    ...
    onTriggered: {
      ...
      collider.applyLinearImpulse(Qt.point(direction * horizontalJumpForce, -verticalJumpForce), collider.body.getWorldCenter())
